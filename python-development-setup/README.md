...
+ rm -rf venv
+ virtualenv venv
created virtual environment CPython3.8.3.final.0-64 in 387ms
...
Installing collected packages: toml, wrapt, six, lazy-object-proxy, astroid, mccabe, isort, pylint
